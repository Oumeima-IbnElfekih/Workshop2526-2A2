...
if(isset($_POST['title']) && isset($_POST['author'])&& isset($_POST['publication_date'])&& isset($_POST['language'])&&isset($_POST['status']) && isset($_POST['number_of_copies']) && isset($_POST['category']) )
{
    ...
    <div class="container mt-4">
        ...
        <form id="addBookForm" method="POST">
          ...
          <div class="mb-3">
            ...
            <span id="publication_date_error"></span>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="copies" name="number_of_copies" placeholder="Enter number of copies">
            <span id="copies_error"></span>
